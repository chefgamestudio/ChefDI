...
using gs.ChefDI.Internal;

namespace gs.ChefDI.Tests
{
    [TestFixture]
    public class ContainerTest
    {
        ...
        public void ResolveAsInterfaces()
        {
            ...
            Assert.Throws<ChefDIException>(() => container.Resolve<MultipleInterfaceServiceA>());
        }
        ...
        public void RegisterInstance()
        {
            ...
            Assert.Throws<ChefDIException>(() => container.Resolve<I3>());
        }
        ...
        public void RegisterFromFuncWithInterface()
        {
            ...
            Assert.That(resolved, Is.InstanceOf<ServiceA>());
            Assert.Throws<ChefDIException>(() => container.Resolve<ServiceA>());
        }
        ...
        //     builder.Register<IDisposable, DisposableServiceA>(Lifetime.Scoped);
        //
        //     Assert.Throws<ChefDIException>(() => builder.Build());
        // }
        ...
        {
            var builder = new ContainerBuilder();
            Assert.Throws<ChefDIException>(() => builder.Register<NoDependencyServiceA>(Lifetime.Scoped).As<I1>());
        }
        ...
        public void ErrorMessageIncludesDependency()
        {
            ...
            var container = builder.Build();
            Assert.Throws<ChefDIException>(() => container.Resolve<AllInjectionFeatureService>(),
                "Failed to resolve ChefDI.Tests.AllInjectionFeatureService : No such registration of type: ChefDI.Tests.I6");
       }
        ...
        public void CircularDependencyMsg()
        {
            ...
            if (injector is ReflectionInjector)
            {
                var ex = Assert.Throws<ChefDIException>(() => builder.Build());
                string expected =
                    "Circular dependency detected!\n" +
                    "    [1] ChefDI.Tests.HasCircularDependencyMsg1..ctor(dependency2) --> ChefDI.Tests.HasCircularDependencyMsg2\n" +
                    "    [2] ChefDI.Tests.HasCircularDependencyMsg2.Method(dependency3) --> ChefDI.Tests.HasCircularDependencyMsg3\n" +
                    "    [3] ChefDI.Tests.HasCircularDependencyMsg3.Field --> ChefDI.Tests.HasCircularDependencyMsg4\n" +
                    "    [4] ChefDI.Tests.HasCircularDependencyMsg4.Prop --> ChefDI.Tests.HasCircularDependencyMsg1";
