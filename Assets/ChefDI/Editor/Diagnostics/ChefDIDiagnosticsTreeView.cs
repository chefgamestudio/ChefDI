...
namespace gs.ChefDI.Editor.Diagnostics
{
    ...
    public sealed class ChefDIDiagnosticsInfoTreeView : TreeView
    {
        ...
        const string SessionStateKeySortedColumnIndex = "ChefDI.Editor.DiagnosticsInfoTreeView:sortedColumnIndex";
        ...
        public ChefDIDiagnosticsInfoTreeView()
            : this(new TreeViewState(), new MultiColumnHeader(new MultiColumnHeaderState(Columns)))
        {
        }

        ChefDIDiagnosticsInfoTreeView(TreeViewState state, MultiColumnHeader header)
            : base(state, header)
        {
            rowHeight = 20;
